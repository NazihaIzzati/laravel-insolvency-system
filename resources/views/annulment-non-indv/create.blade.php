        ...
        <div class="bg-gradient-to-r from-primary-900 to-accent-600 rounded-xl shadow-lg mb-8">
            <div class="px-8 py-12">
                <div class="text-white">
                    ...
                    <p class="text-xl text-primary-100 mb-2">Create a new non-individual annulment record</p>
                    <p class="text-primary-200">Enter company details and annulment information</p>
                </div>
            </div>
        </div>
