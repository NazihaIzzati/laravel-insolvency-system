    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-neutral-900">Bulk Upload Bankruptcy Data</h1>
                    <p class="mt-1 text-sm text-neutral-800">Upload multiple bankruptcy records from Excel file</p>
                </div>
