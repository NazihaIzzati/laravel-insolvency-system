            ...
            <div class="professional-section-content">
                <form method="POST" action="{{ route('annulment-indv.update', $annulmentIndv) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       class="form-input w-full @error('release_date') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       class="form-input w-full @error('release_type') border-red-500 @enderror"
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('annulment-indv.show', $annulmentIndv) }}" class="btn-outline">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
