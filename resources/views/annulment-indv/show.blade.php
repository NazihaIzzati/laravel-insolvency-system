    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 no-print">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-neutral-900">Individual Annulment Record Details</h1>
                    <p class="mt-2 text-neutral-800">View detailed information about the individual annulment record</p>
                </div>
            </div>
        </div>
